...
std::string FunctionName = "Extern_comparator_32bit_unsigned_lteq";
...
Value* W_373 = builder.CreateNot(XInput0to31bits[31]);;
...
Value* W_371 = builder.CreateNot(YInput0to31bits[31]);;
...
Value* W_329 = builder.CreateAnd(W_371, XInput0to31bits[31]);
Value* W_330 = builder.CreateAnd(W_372, XInput0to31bits[27]);
Value* W_331 = builder.CreateAnd(W_373, YInput0to31bits[31]);
